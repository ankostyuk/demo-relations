 ...
 -->
  ...
  <xsl:template match="*" mode="myeval">
    ...
    <xsl:param name="pos">3</xsl:param>
        ...
        <xsl:variable name="dummy"
    select="java:ru.nullpointer.nkbrelation.export.docx.ExtendedBindingTraverserXSLT.log(concat('$pos ', $pos))" />
    
        <xsl:variable name="dummy"
    select="java:ru.nullpointer.nkbrelation.export.docx.ExtendedBindingTraverserXSLT.log(concat('position() ', position() ))" />
    ...
    <xsl:choose>
        ...
        <xsl:when test="w:sdtPr/w:dataBinding and w:sdtPr/w:picture">
            ...
            <xsl:copy>
                 ...
                 <w:sdtContent>
                            <xsl:copy-of
                            select="java:ru.nullpointer.nkbrelation.export.docx.ExtendedBindingTraverserXSLT.xpathInjectImage(
                                        $wmlPackage,
                                        $sourcePart,
        ...
        <xsl:when test="w:sdtPr/w:dataBinding and w:sdtPr/w:date">
            ...
            <xsl:copy>
                 ...
                 <w:sdtContent>
                            <xsl:copy-of
                            select="java:ru.nullpointer.nkbrelation.export.docx.ExtendedBindingTraverserXSLT.xpathDate(
                                        $wmlPackage,
                                        $sourcePart,
                                        $customXmlDataStorageParts,
                                        string(w:sdtPr/w:dataBinding/@w:storeItemID),
                    ...
                    <xsl:choose>
                        ...
                        <!--  When the sdt contains a table, assume block level content is to replace it
                              ...
                              if there were the same number of columns?
                               -->
                            <xsl:copy-of
                            select="java:ru.nullpointer.nkbrelation.export.docx.ExtendedBindingTraverserXSLT.convertXHTML(
                                        $wmlPackage,
                                        $sourcePart,
                                        $customXmlDataStorageParts,
                                        $xPathsPart,
        ...
        <!--  We need to calculate our position. See http://stackoverflow.com/questions/2606186/find-position-of-a-node-within-a-nodeset-using-xpath?rq=1
         -->
            ...
            <xsl:variable name="dummy"
                select="java:ru.nullpointer.nkbrelation.export.docx.ExtendedBindingTraverserXSLT.log(concat('vNodeSet', count($vNodeSet)))" />
            ...
            <xsl:variable name="expression"
                select="java:ru.nullpointer.nkbrelation.export.docx.ExtendedBindingTraverserXSLT.getRepeatPositionCondition(                              
                                        $xPathsPart,
            ...
            <xsl:variable name="dummy"
                select="java:ru.nullpointer.nkbrelation.export.docx.ExtendedBindingTraverserXSLT.log(concat('result ', $result))" />
                                ...
                                <w:tr>
                                    ...
                                    <w:tc>
                                        ...
                                        <w:p>
                                            ...
                                            <xsl:copy-of
                                            select="java:ru.nullpointer.nkbrelation.export.docx.ExtendedBindingTraverserXSLT.xpathGenerateRuns(
                                                        $wmlPackage,
                                                        $sourcePart,
                                                        $customXmlDataStorageParts,
                                                        $xPathsPart,
